# https://github.com/vrialland/micropython-max7219/blob/main/max7219.py
...
class Max7219(framebuf.FrameBuffer):
    ...
    On some matrices, the display is inverted (rotated 180°), in this
    case you can use `rotate_180=True` in the class constructor.
    """
    ...
    def __init__(self, width, height, spi, cs, rotate_180=False):
        ...
        format = framebuf.MONO_HLSB if not self.rotate_180 else\
                framebuf.MONO_HMSB
